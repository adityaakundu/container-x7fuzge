...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x7fuzge.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x7fuzge.containers.anotherwebservice.com/
...
```
git clone git@github.com:adityaakundu/container-x7fuzge.git
cd container-x7fuzge
```
...
```
docker attach container-x7fuzge
```
